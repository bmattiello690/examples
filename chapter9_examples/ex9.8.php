<html><head><title>Conditional Return</title></head>
<body bgcolor="silver">
<div align="center">
<font size="+1">
<?php
   ...
   // If the user filled in the textfield, enter the block
   if ($_REQUEST['time']){
      $num_hours=trim($_REQUEST['time']); /* Remove any leading/trail whitespace */
